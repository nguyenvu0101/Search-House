    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 py-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold fs-3 mb-1'>Thiết bị</span>
        ...
        <div className='mt-5'>
          ...
          <div className='d-flex flex-stack mb-5'>
            ...
            <div className='d-flex align-items-center me-2'>
              ...
              <div>
                ...
                <div className='fs-7 text-muted fw-semibold mt-1'>Danh sách thiết bị đang hoạt động</div>
              </div>
              {/* end::Title */}
            </div>
            {/* end::Section */}
            ...
            {/* begin::Label */}
            <div className='badge badge-light fw-semibold py-4 px-3'>182</div>
            {/* end::Label */}
          </div>
          {/* end::Item */}
          ...
          <div className='d-flex flex-stack mb-5'>
            ...
            <div className='d-flex align-items-center me-2'>
              ...
              <div>
                <a href='#' className='fs-6 text-gray-800 text-hover-primary fw-bold'>
                  Thiết bị đang trục trặc
                </a>
                <div className='fs-7 text-muted fw-semibold mt-1'>Thiết bị đang mất kết nối tới server</div>
              </div>
              {/* end::Title */}
            </div>
            {/* end::Section */}
            ...
            {/* begin::Label */}
            <div className='badge badge-light fw-semibold py-4 px-3'>7</div>
            {/* end::Label */}
          </div>
          {/* end::Item */}
          ...
          <div className='d-flex flex-stack'>
            ...
            <div className='d-flex align-items-center me-2'>
              ...
              <div className='py-1'>
                <a href='#' className='fs-6 text-gray-800 text-hover-primary fw-bold'>
                  Thiết bị đang có người sử dụng
                </a>
            ...
            {/* begin::Label */}
            <div className='badge badge-light fw-semibold py-4 px-3'>54</div>
            {/* end::Label */}
          </div>
          {/* end::Item */}
        </div>
